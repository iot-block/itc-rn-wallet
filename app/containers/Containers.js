...
import BindPhone from "./settings/BindPhone";
import IdentityApprove from "./settings/IdentityApprove";
import OverApprove from "./settings/OverApprove";
import NoApprove from "./settings/NoApprove";
